...
export default class Font3D extends THREE.Object3D{
  constructor(txt,opt){
    super();
    this.type="SpriteText";
    this.name=txt;
    var _opt = {
      size: 50,
      follow:true,
  ...
  getText2D(text,opt){
    ...
    if(opt.follow){
      ...
      let material = new THREE.MeshBasicMaterial({ map: texture,color:0xffffff,alphaMap:texture,transparent:true, side:THREE.DoubleSide,depthTest:false });
